...
public class Conta extends Pessoa {
    ...
    public static void main(String[] args) {
        ...
        str= pega.nextLine();
        c1.setNome(str);
        System.out.println(c1.getNome()+", Qual o número da sua conta?");
        k = pega.nextInt();
        c1.setNumeroDaConta(k); 
        System.out.println(c1.getNome()+", Qual seu saldo inicial?");
        d = pega.nextDouble();
        c1.setSaldo(d);
        do{
            System.out.println("------------------------");
            ...
            System.out.println("------------------------");
            System.out.println(c1.getNome()+", o que deseja fazer:\n1 - SAQUE\n2 - DEPÓSITO\n3 - SAIR");
            k = pega.nextInt();
            switch(k){
                case 1:
